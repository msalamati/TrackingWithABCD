...
%
In this category of problems, we apply \tool to three case studies as discussed next.
...
\KM{Update the RAM if you run the experiment again on desktop.}\MZ{I'll update here when I finished redoing experiments}
