...
\begin{figure}[t]
	...
	\caption{Illustration of the trajectories generated by the open-loop controller for the crane and vehicle example under disturbance-free (\textbf{left}) and perturbed (\textbf{right}) situations \MS{Please change color of the third stage in left figure.}
	\KM{Also, please add frame numbers, because we refer to them using the frame numbers.}} 
