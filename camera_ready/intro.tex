...
\Sadegh{Please indicate the direction of arrow in "controller not found?" }}
\label{fig:overall}
\vspace*{-0.2cm}
\end{figure}
...
SCOTS implements a highly parallelizable \emph{abstraction-based controller synthesis} algorithm that generates a feedback controller for satisfying temporal specification.

We empirically evaluate \tool on a number of multi-robot benchmarks, including coordinated reach-avoid problem for ground robots, formation control problem for drones, and lane merging for autonomous vehicles.
