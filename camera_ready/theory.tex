...
\begin{wrapfigure}{r}{0.2\textwidth}
		...
		\caption{The nominal trajectory (the blue spiral) for the inverted pendulum, the initial state is the red point, and the final state is the green point.} %\Sadegh{Text inside the figure is very small, make it larger so that it is readable.}}
