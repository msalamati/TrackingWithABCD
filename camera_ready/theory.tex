...
\begin{wrapfigure}{r}{0.2\textwidth}
		\includegraphics[width=0.2\textwidth]{figures/inverted_pendulum_plot2.eps}
		\caption{The nominal trajectory (the blue spiral) for the inverted pendulum, the initial state is the red point, and the final state is the yellow point. \KM{Mehrdad: can you increase the fontsize so that they can be read even when we make the figure small?}} %\Sadegh{Text inside the figure is very small, make it larger so that it is readable.}}
