...
\begin{table*}
	...
	\resizebox{1\columnwidth}{!}{
		\begin{tabular}{l|c|ccc|ccc}
			...
			&$T_{AL}$&$N_l$&$T_{l}^{abs}$&$T_{l}^{syn}$&$T_g^{abs}$&$T_g^{syn}$&$N_g$\\
			\midrule
			...
			\multirow{1}{*}{\rotatebox{0}{Crane and forklift}} & $0.65$ & $1.2\times 10^7$&$511$  & $91$&$2.16\times10^{18}$&OM&OM\\
...
\begin{itemize}
	...
	\item The static obstacle $\avoid\subseteq X^\times$ is defined as 
		\begin{align}
			...
			&\Set{ x\in X^\times | 
				\begin{array}{c}
					\exists i\in [1;N]\;.\; D(\proj^i(x),\avoid) \leq \delta\\
					\vee\\
