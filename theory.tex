...
We summarize our approach for solving Prob.~\ref{problem} in Alg.~\ref{alg:main}. \Sadegh{I think it might be better to bring the algorithm as part of the text.}
